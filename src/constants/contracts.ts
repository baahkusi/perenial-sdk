...
export const MultiInvokerAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x40652853a0e51D28F4eb0ca70b48E77B5dC8520E'),
...
export const MarketFactoryAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x247CeaE79E5C5778e00F449eDEC1d49c06f1Ede8'),
...
export const OracleFactoryAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x9229E05f700b543b8056D35149991c1fe72fb846'),
...
export const VerifierAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x35c9C8c07B37899833eaed23a63E233A58a7E9Ef'),
...
export const ControllerAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x708525e662738a1021E09F1C2D0A7bc2d2906250'),
...
export const ManagerAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x863e5bb7C7Ad31d6a7f24818e38ec0d0B293f722'),
...
export const AccountVerifierAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0x176D7B19E2DBA90fdC9533C3d1B585135187bE8d'),
...
export const OrderVerifierAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0xd51b1A9c1F93185A26854976FD2DcCE4655B81F7'),
...
export const USDCAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0xEd64A15A6223588794A976d344990001a065F3f1'),
...
export const PythFactoryAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0xB24D51487C5E8c83BD20330F0c765A91BDccB710'),
...
export const CryptexFactoryAddresses: AddressMapping = {
  ...
  [arbitrumSepolia.id]: getAddress('0xBdf5dc8C77b468Ef3c54dC17222f5Cd2688BaaeD'),
  [perennial.id]: zeroAddress,
  [perennialSepolia.id]: zeroAddress,
}
