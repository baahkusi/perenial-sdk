...
import { Address, Chain, PublicClientConfig, Transport, WalletClient } from 'viem';
import { SupportedChainId, SupportedMarket } from '..';
...
export default class PerennialSDK {
    ...
    private _oracleClients;
    private _graphClient;
    contracts: ContractsModule;
    markets: MarketsModule;
    vaults: VaultsModule;
    operator: OperatorModule;
    oracles: OraclesModule;
    collateralAccounts: CollateralAccountModule;
    constructor(config: SDKConfig);
    get currentChainId(): 60850 | 1424 | 42161 | 421614;
    get rpcProviderUrl(): string;
    get walletClient(): {
        ...
        prepareTransactionRequest: <const request extends import("viem").PrepareTransactionRequestRequest<Chain | undefined, chainOverride_1>, chainOverride_1 extends Chain | undefined = undefined, accountOverride extends `0x${string}` | import("viem").Account | undefined = undefined>(args: import("viem").PrepareTransactionRequestParameters<Chain | undefined, import("viem").Account | undefined, chainOverride_1, accountOverride, request>) => Promise<import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<Chain | undefined, chainOverride_1>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<Chain | undefined, chainOverride_1> extends infer T_15 ? T_15 extends import("viem").DeriveChain<Chain | undefined, chainOverride_1> ? T_15 extends Chain ? {
            chain: T_15;
        } : {
            chain?: undefined;
        ...
        }, (request["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? request["parameters"][number] : "fees" | "gas" | "nonce" | "blobVersionedHashes" | "chainId" | "type") extends infer T_27 ? T_27 extends (request["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? request["parameters"][number] : "fees" | "gas" | "nonce" | "blobVersionedHashes" | "chainId" | "type") ? T_27 extends "fees" ? "gasPrice" | "maxFeePerGas" | "maxPriorityFeePerGas" : T_27 : never : never> & (unknown extends request["kzg"] ? {} : Pick<request, "kzg">) extends infer T_1 ? { [K_1 in keyof T_1]: (import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<Chain | undefined, chainOverride_1>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<Chain | undefined, chainOverride_1> extends infer T_2 ? T_2 extends import("viem").DeriveChain<Chain | undefined, chainOverride_1> ? T_2 extends Chain ? {
            chain: T_2;
        } : {
            chain?: undefined;
        } : never : never) & (import("viem").DeriveAccount<import("viem").Account | undefined, accountOverride> extends infer T_3 ? T_3 extends import("viem").DeriveAccount<import("viem").Account | undefined, accountOverride> ? T_3 extends import("viem").Account ? {
            account: T_3;
            from: `0x${string}`;
        } : {
            account?: undefined;
            ...
            chainId?: number | undefined;
        }, (request["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? request["parameters"][number] : "fees" | "gas" | "nonce" | "blobVersionedHashes" | "chainId" | "type") extends infer T_14 ? T_14 extends (request["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? request["parameters"][number] : "fees" | "gas" | "nonce" | "blobVersionedHashes" | "chainId" | "type") ? T_14 extends "fees" ? "gasPrice" | "maxFeePerGas" | "maxPriorityFeePerGas" : T_14 : never : never> & (unknown extends request["kzg"] ? {} : Pick<request, "kzg">))[K_1]; } : never>;
        requestAddresses: () => Promise<import("viem").RequestAddressesReturnType>;
        requestPermissions: (args: {
            [x: string]: Record<string, any>;
            eth_accounts: Record<string, any>;
        }) => Promise<import("viem").RequestPermissionsReturnType>;
        sendCalls: <const calls extends readonly unknown[], chainOverride_2 extends Chain | undefined = undefined>(parameters: import("viem").SendCallsParameters<Chain | undefined, import("viem").Account | undefined, chainOverride_2, calls>) => Promise<{
            capabilities?: {
                [x: string]: any;
            } | undefined;
            id: string;
        ...
        sendTransaction: <const request_1 extends import("viem").SendTransactionRequest<Chain | undefined, chainOverride_3>, chainOverride_3 extends Chain | undefined = undefined>(args: import("viem").SendTransactionParameters<Chain | undefined, import("viem").Account | undefined, chainOverride_3, request_1>) => Promise<`0x${string}`>;
        ...
        signTransaction: <chainOverride_4 extends Chain | undefined, const request_2 extends import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<Chain | undefined, chainOverride_4>, "transactionRequest", import("viem").TransactionRequest>, "from"> = import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<Chain | undefined, chainOverride_4>, "transactionRequest", import("viem").TransactionRequest>, "from">>(args: import("viem").SignTransactionParameters<Chain | undefined, import("viem").Account | undefined, chainOverride_4, request_2>) => Promise<import("viem").TransactionSerialized<import("viem").GetTransactionType<request_2, (request_2 extends {
            accessList?: undefined;
            authorizationList?: undefined;
            blobs?: undefined;
            blobVersionedHashes?: undefined;
        ...
        writeContract: <const abi_1 extends import("viem").Abi | readonly unknown[], functionName extends import("viem").ContractFunctionName<abi_1, "nonpayable" | "payable">, args extends import("viem").ContractFunctionArgs<abi_1, "nonpayable" | "payable", functionName>, chainOverride_5 extends Chain | undefined = undefined>(args: import("viem").WriteContractParameters<abi_1, functionName, args, Chain | undefined, import("viem").Account | undefined, chainOverride_5>) => Promise<`0x${string}`>;
        extend: <const client extends {
            ...
            type?: undefined;
            uid?: undefined;
        } & import("viem").ExactPartial<Pick<import("viem").PublicActions<Transport, Chain | undefined, import("viem").Account | undefined>, "call" | "createContractEventFilter" | "createEventFilter" | "estimateContractGas" | "estimateGas" | "getBlock" | "getBlockNumber" | "getChainId" | "getContractEvents" | "getEnsText" | "getFilterChanges" | "getGasPrice" | "getLogs" | "getTransaction" | "getTransactionCount" | "getTransactionReceipt" | "prepareTransactionRequest" | "readContract" | "sendRawTransaction" | "simulateContract" | "uninstallFilter" | "watchBlockNumber" | "watchContractEvent"> & Pick<import("viem").WalletActions<Chain | undefined, import("viem").Account | undefined>, "sendTransaction" | "writeContract">>>(fn: (client: import("viem").Client<Transport, Chain | undefined, import("viem").Account | undefined, import("viem").WalletRpcSchema, import("viem").WalletActions<Chain | undefined, import("viem").Account | undefined>>) => client) => import("viem").Client<Transport, Chain | undefined, import("viem").Account | undefined, import("viem").WalletRpcSchema, { [K_2 in keyof client]: client[K_2]; } & import("viem").WalletActions<Chain | undefined, import("viem").Account | undefined>>;
    } | undefined;
    get publicClient(): {
        account: undefined;
        batch?: {
        ...
        transport: import("viem").TransportConfig<"http", import("viem").EIP1193RequestFn> & Record<string, any>;
        type: string;
        uid: string;
        ...
        extend: <const client extends {
            ...
            type?: undefined;
            uid?: undefined;
        } & import("viem").ExactPartial<Pick<import("viem").PublicActions<Transport<"http">, Chain, undefined>, "call" | "createContractEventFilter" | "createEventFilter" | "estimateContractGas" | "estimateGas" | "getBlock" | "getBlockNumber" | "getChainId" | "getContractEvents" | "getEnsText" | "getFilterChanges" | "getGasPrice" | "getLogs" | "getTransaction" | "getTransactionCount" | "getTransactionReceipt" | "prepareTransactionRequest" | "readContract" | "sendRawTransaction" | "simulateContract" | "uninstallFilter" | "watchBlockNumber" | "watchContractEvent"> & Pick<import("viem").WalletActions<Chain, undefined>, "sendTransaction" | "writeContract">>>(fn: (client: import("viem").Client<Transport<"http">, Chain, undefined, import("viem").PublicRpcSchema, import("viem").PublicActions<Transport<"http">, Chain>>) => client) => import("viem").Client<Transport<"http">, Chain, undefined, import("viem").PublicRpcSchema, { [K_2 in keyof client]: client[K_2]; } & import("viem").PublicActions<Transport<"http">, Chain>>;
    };
    get graphClient(): GraphQLClient;
    get oracleClients(): OracleClients;
    get supportedMarkets(): SupportedMarket[];
    private buildPythClients;
}
