...
export type JumpRateUtilizationCurve = ContractFunctionReturnType<typeof MarketAbi, 'view', 'riskParameter'>['utilizationCurve'];
export type MultiInvokerAction = Exclude<ContractFunctionArgs<typeof MultiInvokerAbi, 'payable', 'invoke'>[0], string>[number];
